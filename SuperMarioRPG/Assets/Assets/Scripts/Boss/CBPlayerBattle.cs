...
public class CBPlayerBattle : MonoBehaviour
{
    #region public
    public CBattleManager btlManager = null;
    public CBMstCtl monApr = null;
    ...
    IEnumerator AttackMove()
    {
        ...
        while (sumTime <= 0.5f)
        {
            trans.position = Vector3.Lerp(trans.position, monPos[btlManager.curAttack] + new Vector3(0f, 0f, 1f), sumTime / 0.5f);
    ...
    IEnumerator MarioJump()
    {
        ...
        Vector3 targetPos = new Vector3(monPos[btlManager.curAttack].x, GameManager.instance.curMoster[monster].m_monsterPosY + 2f, monPos[btlManager.curAttack].z - 1f);
        float sumTime = 0f;
